...
const ProductsItem = () => {
  ...
  const isAllShown = (currentPage + 1) * PAGE_SIZE >= allImages.length;
  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col mb-28" id="products">
      <section className="relative h-[60vh] w-full flex items-center">
        <img src={industry} className="absolute w-full h-full object-cover" />
